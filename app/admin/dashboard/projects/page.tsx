...
const emptyProject: Partial<Project> = {
  ...
  client: "",
  location: "",
  category: "xu-ly-nuoc-thai",
  categoryLabel: "Xử lý nước thải",
  capacity: "",
    ...
    <div>
      ...
      >
        <div>
          ...
          <p
            style={{ color: "var(--admin-text-light)", fontSize: "0.8125rem" }}
          >
            ...
            >
              ...
              <div style={{ gridColumn: "1 / -1" }}>
                ...
                <input
                  ...
                  placeholder="MBR, UASB, Nước thải công nghiệp"
                />
              </div>
              <div>
