...
import { Settings, PenTool, ClipboardCheck, ArrowRight, ShieldCheck, Zap } from 'lucide-react'
...
const expertises = [
  {
    ...
    description: 'Tư vấn và thiết kế các quy trình công nghệ xử lý nước thải, khí thải và chất thải rắn tiên tiến, tối ưu chi phí vận hành.',
  ...
  },
  {
    ...
    description: 'Cung cấp và lắp đặt hệ thống thiết bị xử lý môi trường trọn gói, đảm bảo tính đồng bộ và hiệu suất cao nhất.',
  ...
  },
  {
    ...
    description: 'Lập báo cáo nghiên cứu khả thi, báo cáo kinh tế kỹ thuật và hoàn thiện hồ sơ pháp lý cho các dự án đầu tư môi trường.',
          ...
          <div className="lg:w-1/3 lg:sticky lg:top-32">
            <AnimatedSection direction="left">
              ...
              <p className="text-gray-600 leading-relaxed mb-8">
                Với hơn 15 năm kinh nghiệm, chúng tôi không chỉ cung cấp dịch vụ đơn thuần, mà mang đến giải pháp kỹ thuật tổng thể cho mọi vấn đề môi trường của doanh nghiệp.
              </p>
              ...
              {expertises.map((item, index) => (
                ...
                >
                  <div className="flex flex-col md:flex-row gap-8 items-start">
                    <div className={`flex-shrink-0 w-16 h-16 rounded-2xl bg-gradient-to-br ${item.color} flex items-center justify-center group-hover:scale-110 transition-transform duration-500`}>
                    ...
                    <div className="flex-grow">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {item.tags.map(tag => (
                          <span key={tag} className="px-3 py-1 bg-white border border-gray-100 rounded-full text-xs font-medium text-gray-500 group-hover:border-green-100 group-hover:text-green-600 transition-colors">
                            {tag}
                          </span>
                        ))}
                      </div>
